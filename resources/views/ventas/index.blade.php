                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div id="corteDeCajaModal"
                                ...
                                <div style="background: white; padding: 40px; width: 500px; margin: 100px auto;">
                                    <h2>Corte de Caja</h2>
                                    <form action="{{ route('ventas.corteDeCaja') }}" method="POST">
                                        @csrf
                                        <label for="montoInicial">Monto Inicial del Día:</label>
                                        <input class="form-control" type="number" name="montoInicial" id="montoInicial"
                                            step="0.01" min="0" required>
                                        <button type="submit" class="btn btn-primary mt-3">Generar Corte</button>
                                    </form>
                                    <button class="btn btn-light    " onclick="closeCorteDeCajaModal();"
                            ...
                            <div id="reportePorRangoModal"
                                ...
                                <div style="background: white; padding: 20px; width: 300px; margin: 100px auto;">
                                    ...
                                    <button class="btn btn-light" onclick="closeReportePorRangoModal();">Cerrar</button>
                                </div>
                            </div>
...
function showModal(ventaId) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            detalleVentaBody.innerHTML = '';
            data.forEach(function(item) {
                detalleVentaBody.innerHTML += '<tr><td>' + item.producto + '</td><td>' + item
                    .cantidad + '</td></tr>';
            });
        }
    });
