                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                                @can('crear-materia')
                                    <a class="btn btn-info mx-3" href="{{ route('materias.create') }}">
                                        <i class="fas fa-plus"></i> Nuevo ingrediente
                                    </a>
                                    <a class="btn btn-info" href="{{ route('materias.showChargeForm') }}">
                            ...
                            <div class="table-responsive mt-3">
                                <table class="table table-striped mt-2" id="miTabla2">
                                    <thead style="background-color:#800000; text-align: center;">
                                        <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    @can('editar-materia')
                                                        <a href="{{ route('materias.edit', $materia->id) }}"
                                                            class="btn btn-light mr-1 css-button-sliding-to-left--yellow">
                                ...
                                @foreach ($materias as $materia)
                                    <div class="mobile-card d-lg-none">
                                        <div class="row">
                                            ...
                                            <div class="col-6">{{ $materia->id }}</div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="row action-buttons">
                                                ...
                                                @can('borrar-materia')
                                                    <form action="{{ route('materias.destroy', $materia->id) }}" method="POST"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="button"
                                                            class="btn btn-danger css-button-sliding-to-left--red"
